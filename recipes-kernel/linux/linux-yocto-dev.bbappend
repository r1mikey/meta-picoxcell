...
SRC_URI = "git://github.com/r1mikey/linux-picoxcell.git;branch=${KBRANCH};name=machine \
           git://github.com/r1mikey/yocto-kernel-cache-picoxcell.git;type=kmeta;name=meta;branch=${MBRANCH};destsuffix=${KMETA}"
